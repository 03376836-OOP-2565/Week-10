...
```
![image](https://github.com/Poramat45/Week-10/assets/115066249/bb52571d-5b8c-44d7-9cf2-f463e9ff3d51)
...
```
![image](https://github.com/Poramat45/Week-10/assets/115066249/7c091aa3-97e6-4636-be58-88ac1bd498b7)
...
```
![image](https://github.com/Poramat45/Week-10/assets/115066249/a2283891-56ee-49d5-8bb6-eaeddc37e548)

## คำถาม
1. ประโยชน์ของการทำ Inhertiance ทั้งจากที่ท่านเข้าใจและได้เห็นจากตัวอย่างนี้มีอะไรบ้าง
* ประโยชน์ของการทำ Inheritance ได้แก่การเพิ่มความสามารถของคลาสลูก โดยสืบทอดคุณสมบัติ และพฤติกรรมจากคลาสแม่ ทำให้ลดการเขียนโค้ดซ้ำซ้อน และทำให้การจัดการโค้ดเป็นลำดับชั้นเหมือนกัน ทำให้โค้ดมีความยืดหยุ่นและการบำรุงรักษาง่ายขึ้น
เช่น ในตัวอย่างของคลาส Employee และคลาส Manager โดย Manager สืบทอดคุณสมบัติและพฤติกรรมจาก Employee และเพิ่มคุณสมบัติเป็นส่วนของตัวเองอีก เช่น คุณสมบัติการคำนวณเงินเดือนโบนัส เป็นต้น

2. ท่านคิดว่า คลาสพนักงาน (Employee) และ หัวหน้างาน (Supervisor) คลาสใดควรเป็น base class เพราะเหตุใด
* คลาส Employee ควรเป็น base class เพราะ Supervisor เป็นคลาสที่สืบทอดคุณสมบัติและพฤติกรรมจากคลาส Employee โดยมีการเพิ่มคุณสมบัติของตัวเองเพิ่มเติม การสืบทอดจาก Employee จะช่วยให้ Supervisor สามารถใช้คุณสมบัติและพฤติกรรมของ Employee ได้ และทำให้การออกแบบและการจัดการโค้ดเป็นลำดับชั้น สามารถเพิ่มเติมและปรับปรุงคุณสมบัติและพฤติกรรมของ Employee และ Supervisor ได้ง่ายขึ้น ซึ่งสามารถลดความซับซ้อนและเพิ่มความยืดหยุ่นในการออกแบบและการบำรุงรักษาโค้ดได้ดีขึ้น
