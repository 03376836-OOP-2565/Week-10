...
namespace VirtualOverrideExample
{
    ...
    class LandVehicle : Vehicle
    {
        public override void Move()
        {
            Console.WriteLine("Move: I move by driving on the ground");
        }
    }
...
```
![image](https://github.com/tnpn2545/Week-10/assets/115066414/487f1793-35d5-48ee-b00c-89ed0ce3386d)
...
namespace VirtualOverrideExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Now create an array to store 4 air vehicles");
            Console.WriteLine("and assign references to the existing vehicles (chopper, plane, drone, glider).");
            AVarray[0] = c;  // type of c = Chopper
            AVarray[1] = p;  // type of p = Plane
            AVarray[2] = new Drone();
            AVarray[3] = new Glider();

            Console.WriteLine("Moving each vehicle using a foreach loop:");
            foreach (AirVehicle a in AVarray)
                a.Move();
        }
    }
...
```
![image](https://github.com/tnpn2545/Week-10/assets/115066414/74651da3-10bb-455d-8f7a-2dbdba7bda51)
