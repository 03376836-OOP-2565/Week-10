...
```
![image](https://user-images.githubusercontent.com/103983336/236625781-0064753d-13a2-4fa0-b604-d326a684367f.png)
...
```
![image](https://user-images.githubusercontent.com/103983336/236625828-e2c9b678-fd1d-46c6-839a-0194e2eb39d0.png)
...
```
![image](https://user-images.githubusercontent.com/103983336/236625888-5ad026d0-d077-4b39-b5e2-563b343f95b4.png)

## คำถาม
1. ประโยชน์ของการทำ Inhertiance ทั้งจากที่ท่านเข้าใจและได้เห็นจากตัวอย่างนี้มีอะไรบ้าง
```
ประโยชน์ของการทำ Inhertiance เพื่อลดการเขียนโค้ดซ้ำและประหยัดเวลาโดยสามารถเพิ่มคุณสมบัติของคลาสได้และได้คุณสมบัติเก่าจาก base class ด้วยเมื่อ base class มีการอัปเดต จะได้คุณสมบัติจาก base class ด้วย  
```
2. ท่านคิดว่า คลาสพนักงาน (Employee) และ หัวหน้างาน (Supervisor) คลาสใดควรเป็น base class เพราะเหตุใด
```
class Supervisor เพราะคุณสมบัติจากคลาส Supervisor จะมีความละเอียดมากกว่าคลาส emloyee สามารถระบุตำแหน่งของพนักงานได้ด้วย
```
