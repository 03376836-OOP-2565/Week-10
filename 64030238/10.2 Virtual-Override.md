...
```
```
โค้ด Error เนื่องไม่ได้สร้าง class LandVehicle
```
![image](https://user-images.githubusercontent.com/103983336/236626555-bc1f1493-b9c3-4585-ad66-d3c1b2a09707.png)
```
![image](https://user-images.githubusercontent.com/103983336/236626639-a739736a-7592-4a30-8d4f-1c4bf4447a2b.png)
...
```
![image](https://user-images.githubusercontent.com/103983336/236626676-fea45e85-d948-4a4d-8ab3-29b38ced90e2.png)
...
namespace VirtualOverrideExample
{
    ...
    class Drone : AirVehicle
    {
        public override void Move()
        {
            Console.WriteLine("Move: by rotors and remote control");
        }
    }
    class Glider : AirVehicle
    {
        public override void Move()
        {
            Console.WriteLine("Move: by wings an spolier");
        }
    }
    internal class Program
    {
...
```
![image](https://user-images.githubusercontent.com/103983336/236627182-6bf26a45-ab95-4417-83dc-df68c7cb1685.png)
