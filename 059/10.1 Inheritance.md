...
```
### ผลการทดลอง
![image](https://user-images.githubusercontent.com/100436724/236632679-a444c376-1eca-4013-b360-35b93bf3b0b9.png)
...
```
### ผลการทดลอง
![image](https://user-images.githubusercontent.com/100436724/236632698-6a1e60e7-48b2-4142-9b9a-ac39e53dfa18.png)
...
```
### ผลการทดลอง
![image](https://user-images.githubusercontent.com/100436724/236632716-da08d403-6b86-420e-b083-7518266917f9.png)
...
มีความสามารถในการแก้ไขและปรับปรุง
```
2. ท่านคิดว่า คลาสพนักงาน (Employee) และ หัวหน้างาน (Supervisor) คลาสใดควรเป็น base class เพราะเหตุใด
```
class Employeeเพราะ class supervisor ก็เป็นพนักงานเหมือนกันแค่อยู่คนละตำแหน่ง
```
