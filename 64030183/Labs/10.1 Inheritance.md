...
```
![image](https://user-images.githubusercontent.com/115066431/236670433-6f72dd7d-6bf4-4669-852c-a4600b72a227.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236670462-9826f72a-8683-4832-9789-dfa049483058.png)
...
```
![image](https://user-images.githubusercontent.com/115066431/236670493-e4ffc8e4-a496-4e6e-be1b-bb5eaf1a2a16.png)

## คำถาม
1. ประโยชน์ของการทำ Inhertiance ทั้งจากที่ท่านเข้าใจและได้เห็นจากตัวอย่างนี้มีอะไรบ้าง
```cs
ลดการเขียนโค้ดซ้ำซ้อน คลาสลูกสามารถสืบทอดคุณสมบัติและพฤติกรรมจากคลาสแม่ได้
ทำให้โค้ดมีความยืดหยุ่นมากขึ้นเพราะสามารถสร้างคลาสลูกจากคลาสแม่ได้
ทำให้โค้ดดูเรียบง่าย
```
2. ท่านคิดว่า คลาสพนักงาน (Employee) และ หัวหน้างาน (Supervisor) คลาสใดควรเป็น base class เพราะเหตุใด
```cs
คลาสพนักงาน (Employee) ควรเป็น base class เนื่องจากหัวหน้างาน (Supervisor) เป็นพนักงานที่มีคุณสมบัติเดียวกับพนักงาน (Employee) แต่มีความสามารถเพิ่มเติม เช่น สามารถควบคุมงานของพนักงานทั้งหมดในทีม หรือกำหนดงานให้กับพนักงาน เป็นต้น สามารถสืบทอดคุณสมบัติและพฤติกรรมจากคลาสพนักงาน (Employee) ได้โดยตรง และเพิ่มเติมคุณสมบัติและพฤติกรรมเพิ่มเติมของตนเองเพื่อสร้างคลาสหัวหน้างาน
```
